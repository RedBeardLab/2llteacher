    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_chats', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'chat_chat',
                'ordering': ['-created_at'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contexts', to='chat.chatmessage')),
            ],
            options={
