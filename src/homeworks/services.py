...
class HomeworkService:
    ...
    @staticmethod
    @traced
    def get_course_homework_matrix(
        course_id: UUID,
    ) -> "HomeworkMatrixData | None":
        """
        Get a matrix view of all students and homeworks for a specific course.
        ...
        try:
            ...
            logger.exception("Error getting course homework matrix")
            record_exception(e)
            return None
